...
namespace GameToolKit.Dialog
{
    ...
    public abstract class DialogNode : DialogNodeBase
    {
        ...
        {
            var dialog = ServiceAP.Instance.GetService<IDialogViewManager>().GetDialogBox(ViewType);
    ...
    public class OptionSelectorNode : DialogNodeBase
    {
        ...
        protected override void OnPlay()
        {
            ...
            ServiceAP.Instance.GetService<IDialogViewManager>().GetOptionalView(ViewType)
