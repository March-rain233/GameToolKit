...
namespace GameToolKit.Behavior.Tree.Editor
{
    ...
    public class BehaviorTreeView : DataFlowGraphView<BehaviorTree, Node>
    {
        ...
        {
            BehaviorTreeView _view;
            public override IEnumerable<int> Nodes => _nodes;
            List<int> _nodes;
            public GraphLayoutAdapter(BehaviorTreeView view)
            {
                _view = view;
                _nodes = new();
        ...
        public override void PopulateView(DataFlowGraph<BehaviorTree, Node> graph)
        {
